...
class AddCustomer:
    ...
    def clickOnAddnew(self):
        time.sleep(5)
        #self.driver.find_element(By.XPATH, '/html/body/div[3]/div[1]/form[1]/div/div/a').click()
    ...
    def setCustomerRoles(self, role):
        ...
        time.sleep(3)
        if role == 'Registered':
            self.listitem = self.driver.find_element(By.XPATH, self.stitemRegistered_xpath)
